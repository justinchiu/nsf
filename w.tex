...
define heuristics for evaluating a summary's fidelity to the underlying data.

\paragraph{Why is D2T important?}
\begin{itemize}
\item Easily evaluable, good benchmark
\item Limited external knowledge, largely concerned with reporting the information in the table
\end{itemize}
