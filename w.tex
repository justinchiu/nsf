...
The prior is simply a language model over records.
(This is the simplest baseline, can make things much more complicated)
(Posterior is actually tractable for this, since it's an HSMM,
will change this later)

Our IE model is given by $p(\bc\mid\by,\br)$,
...
(Structured attention for pairwise potentials)
...
(i.e. its representation admitted by the Hammersley-Clifford theorem),
