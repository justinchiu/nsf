...
using a LVM to aligning segments in summaries to records.
Although the work achieved
...
We will scale HSMMs to large datasets through variational inference and use
the signal from our generative model, the HSMM, in order to train an information extraction system (redundant).
...
\item Introduction
    ...
    \item Supervision in NLU
        ...
        \item Highlight issues with this? Where do labels come from? What if we want to change our representation?
