...
In order to provide decision makers with the information and context
necessary to make informed choices, information networks must
1) contain correct information in each node, as well as 
2) represent the relationships between nodes efficiently in order to propagate changes dynamically,
...
In order to satisfy condition 1) or correctness for knowledge bases,
...
\item Introduction
    ...
    \item Supervision in Information Extraction
        ...
        \item We aim to unify these two approaches with recent techniques for training LVMs
