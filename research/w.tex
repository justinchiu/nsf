...
A decision maker may query the relevant nodes to gain context, and
...
extract facts from text in order to fill in the nodes of a knowledge graph.
...
\item Introduction
    ...
    \item Supervision in Information Extraction
        ...
        \item Define information extraction
            \begin{enumerate}
            \item The goal is to produce structured representations of information from a given unstructured text.
